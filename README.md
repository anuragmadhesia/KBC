...
## Platform notes
The current implementation uses `conio.h` and `system("PAUSE")`, so it targets Windows-compatible toolchains. If you want to run it on other platforms, replace those calls with portable alternatives.
